...
<footer style="position:relative;opacity:1;transform:none;filter:none;">
  <div class="footer__left">
    ...
    <div class="footer__socials">
      <a href="https://docs.google.com/document/d/17Sbe0jfaM_j-DL7hASyOlNv6RHQaP1VL7gTOgmSByLw/edit?tab=t.0" target="_blank" rel="noopener">Resume</a><span class="footer__sep">&middot;</span>
  ...
  <div class="footer__right">
    <ul class="footer__nav">
      <li class="footer__col">
        ...
        <a href="password.html?to=abule-adminportal.html" class="footer__link--sub icon-link"><i class="ph ph-lock-key" style="margin-right:6px; font-size:1.1em; vertical-align:-2px;"></i><span>Admin Portal Design</span></a>
